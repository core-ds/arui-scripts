...
export const ServerStateModuleCompat = (props: { runParams: any, serverState: any }) => (
    <div>
        Это модуль ServerStateModuleCompat, который был загружен в режиме compat.
        Главное его отличие от ModuleCompat - это то, что при его загрузке на страницу, он сразу же получает
        данные с сервера.
        <div>
