...
import { getDockerBuildCommand } from './build-command';
import { applyCommandLineArguments, getBuildParams } from './build-params';
import { prepareFilesForDocker } from './prepare-files';
...
export type BuildDockerImageOptions = ArtifactsOptions & {
     ...
     * `docker build`. Если приложение собирается им, выставьте `build.command: null`.
     */
