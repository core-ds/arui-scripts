...
describe('loadConfigFile', () => {
    it('should load a TypeScript config without any extra loader', async () => {
        ...
        expect(config.baseDockerImage).toBe('fixture/base:1.0.0');
        expect(config.nginx).toEqual({ workerProcesses: 7 });
