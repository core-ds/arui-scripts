...
-   [#599](https://github.com/core-ds/arui-scripts/pull/599) [`03f84fad`](https://github.com/core-ds/arui-scripts/commit/03f84fadb4d4a13c455624630d1902113ac29906) Thanks [@Burzachil](https://github.com/Burzachil)! - **Что изменилось**
    Rspack обновлён с 2.0.0 до 2.2.5 (анонсы [2.1](https://rspack.rs/blog/announcing-2-1) и [2.2](https://rspack.rs/blog/announcing-2-2)): исправлены ошибки генерации кода, утечки памяти в dev-режиме и CSS HMR. Вместе с ним обновлены `@swc/core`, `swc-plugin-coverage-instrument`, `ts-checker-rspack-plugin` (проверка типов в `build` стала быстрее), `@rsdoctor/rspack-plugin` и `rspack-manifest-plugin`.
...
-   [#507](https://github.com/core-ds/arui-scripts/pull/507) [`ed3c42b`](https://github.com/core-ds/arui-scripts/commit/ed3c42b75644b626fbfeb40fb6944160a33f84b1) Thanks [@heymdall-legal](https://github.com/heymdall-legal)! - SWC больше не использует loose режим по умолчанию. Это меняет то, как именно собирается код.
...
-   [#470](https://github.com/core-ds/arui-scripts/pull/470) [`6f3178f`](https://github.com/core-ds/arui-scripts/commit/6f3178f9e6e37d4b21d1bcd08a9ad6c469ae59c2) Thanks [@dmitrbrvsk](https://github.com/dmitrbrvsk)! - В **arui-scripts** переведены инструменты сборки на **Rspack 2** и **@rspack/dev-server 2**.
...
-   [#449](https://github.com/core-ds/arui-scripts/pull/449) [`63a7336`](https://github.com/core-ds/arui-scripts/commit/63a7336cc279d6eeab3bc8ba24246a036e683d72) Thanks [@heymdall-legal](https://github.com/heymdall-legal)! - Добавлена поддержка ts@6. Удалена поддержка ts@4.
...
-   [#406](https://github.com/core-ds/arui-scripts/pull/406) [`ed27ca7`](https://github.com/core-ds/arui-scripts/commit/ed27ca7355cd816121ec2a08c742267794becf09) Thanks [@ElfistIO](https://github.com/ElfistIO)! - Обновлена версия swc-plugin-coverage-instrument с 0.0.28 до 0.0.32
