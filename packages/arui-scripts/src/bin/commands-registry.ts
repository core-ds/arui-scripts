...
export const commands: CliCommand[] = [
    ...
    {
        name: 'start:prod',
        description: 'То же, что команда start, но с production конфигурацией rspack',
    ...
    },
    {
        ...
        description:
            'Как docker-build, но использует уже скомпилированный код из папки .build (для CI/CD)',
        help: [
