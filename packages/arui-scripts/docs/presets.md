...
Для того, чтобы использовать пресеты на проекте, вы должны указать в настройках проекта имя пакета с пресетами:
...
На проекте конфигурация будет загружаться в следующем порядке:
